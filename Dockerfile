...
WORKDIR /storage/
RUN echo "/storage *(rw,fsid=0,insecure,no_root_squash,no_subtree_check,sync)" > /sotrage/docker-nfs-server/exports
RUN ln -s /sotrage/docker-nfs-server/exports /etc/exports
